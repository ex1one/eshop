...
export const EditableCell = ({
  ...
  if (dtCol?.select) {
    let defaultText = dtCol.defaultText && dtCol.defaultText(row.original)
    let defaultValue = dtCol.defaultValue && dtCol.defaultValue(row.original)
    return <Select {...{ column, updateMyData, row, initialValue, defaultText, defaultValue }} />
  }
  // if (dtCol?.path == "balanceChange") debugger

  return <EditableCellInput {...{ value: initialValue, row, column, updateMyData }} />
}
